 ...
 *
 * // TODO-DOCS
 * If [exitButton] is present, a button for it will appear in the footer, otherwise the footer is not present. [exitButton] is also used for the Escape action.
 */
open class MultiActionDialogMenu(
    ...
    override val totalButtons: List<DialogButton>
        get() = if (exitButton != null) super.totalButtons + buttons + exitButton else super.totalButtons + buttons
    ...
    override fun toJson() = super.toJson().also { json ->
        ...
        if (exitButton != null) json.add("exit_columns", exitButton.toJson())
    }
