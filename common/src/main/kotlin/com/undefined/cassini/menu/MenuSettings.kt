 ...
 * A "general menu" refers to a menu that is extended by other menus and is by itself not a menu, such as [com.undefined.cassini.menu.item.ItemMenu] or [CassiniMenu].
 *
