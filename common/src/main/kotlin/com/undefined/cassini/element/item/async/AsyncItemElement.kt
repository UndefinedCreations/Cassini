 ...
 */
abstract class AsyncItemElement(cardinalSlot: CartesianCoordinate? = null, slot: Int? = null, val fallbackItem: (Player) -> ItemStack) : AbstractItemElement(cardinalSlot, slot) {
    companion object {
        // BASE
        fun suspend(cardinalSlot: CartesianCoordinate? = null, slot: Int? = null, fallbackItem: (Player) -> ItemStack, item: suspend (Player) -> ItemStack): SuspendAsyncItemElement = SuspendAsyncItemElement(cardinalSlot, slot, fallbackItem, item)
        ...
        fun suspend(cardinalSlot: CartesianCoordinate? = null, slot: Int? = null, fallbackItem: ItemStack, item: suspend (Player) -> ItemStack): SuspendAsyncItemElement = SuspendAsyncItemElement(cardinalSlot, slot, { fallbackItem }, item)
        ...
        // BASE
        fun future(cardinalSlot: CartesianCoordinate? = null, slot: Int? = null, fallbackItem: (Player) -> ItemStack, item: (Player) -> CompletableFuture<ItemStack>): CompletableFutureItemElement = CompletableFutureItemElement(cardinalSlot, slot, fallbackItem, item)
        ...
        fun future(cardinalSlot: CartesianCoordinate? = null, slot: Int? = null, fallbackItem: ItemStack, item: (Player) -> CompletableFuture<ItemStack>): CompletableFutureItemElement = CompletableFutureItemElement(cardinalSlot, slot, { fallbackItem }, item)
        ...
        // BASE
        fun reactive(cardinalSlot: CartesianCoordinate? = null, slot: Int? = null, fallbackItem: (Player) -> ItemStack, item: (Player) -> Mono<ItemStack>): ReactiveItemElement = ReactiveItemElement(cardinalSlot, slot, fallbackItem, item)
        ...
        fun reactive(cardinalSlot: CartesianCoordinate? = null, slot: Int? = null, fallbackItem: ItemStack, item: (Player) -> Mono<ItemStack>): ReactiveItemElement = ReactiveItemElement(cardinalSlot, slot, { fallbackItem }, item)
